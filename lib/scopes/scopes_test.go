...
import (
	...
	"github.com/gravitational/teleport/lib/itertools/seq"
)
...
func TestJoin(t *testing.T) {
	...
	for _, tt := range tts {
		t.Run(tt.name, func(t *testing.T) {
			...
			reSegmented := seq.Collect(DescendingSegments(joined))
